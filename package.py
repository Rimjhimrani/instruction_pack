                ...
                if matching_image:
                    try:
                        ...
                        if area_type == 'current_packaging':
                            ...
                            # Get the header row and add offset
                            target_row = area['row'] + 1  # Move one row below heade
                        else:
                            ...
                            cell_coord = f"{get_column_letter(area['column'])}{target_row}"
                        ...
                        st.warning(f"Could not add image to {area.get('position', area_type)}: {e}")
                        continue
